...
export const StatusBar = ({ platform }: StatusBarProps) => {
    ...
    return (
        <div className={`absolute top-0 left-0 right-0 h-[44px] z-50 flex items-center justify-between px-6 font-medium text-[15px] select-none ${textColor} transition-colors duration-75`}>
            {/* Time */}
